...
has_p_info_pages=0
p_list_url='https://www.amazon.in/s/ref=s9_acss_bw_cts_VodooFS_T3L4_w?rh=n%3A976419031%2Cn%3A!976420031%2Cn%3A1389401031%2Cn%3A1389432031%2Cn%3A1805560031%2Cp_36%3A1318505031&qid=1484135884&bbn=1805560031&low-price=10%2C000&high-price=15%2C000&x=16&y=9&pf_rd_m=A1K21FY43GMZF8&pf_rd_s=merchandised-search-7&pf_rd_r=V9060E9AEDXMKC8SMK73&pf_rd_t=101&pf_rd_p=476f8f1a-15ac-4693-b157-8657b9ebf7e1&pf_rd_i=1389401031'
...
def go_p_list_page(p_list_url):
	...
	while True:
		...
		for thread in all_thread:
			thread.join()
		if 	next_page_url=='':
			print 'end of product list page,break:'+url+",p_info_urls length:"+str(p_info_urls)
			break
		else:
			url=next_page_url
